...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
		...
		$data['column_email'] =  $this->language->get('column_author');
		...
		$data['sort_author'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'] . '&sort=r.author' . $url, true);
			$data['sort_email'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'] . '&sort=r.email' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->error['emai'])) {
			$data['error_email'] = $this->error['emai'];
		} else {
			$data['error_email'] = '';
		}

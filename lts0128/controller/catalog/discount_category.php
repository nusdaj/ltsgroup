<?php
class ControllerCatalogDiscountCategory extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('catalog/category_discount');
		...
		if (isset($this->request->post['category_discount_override_special_price'])) {
			$data['category_discount_override_special_price'] = $this->request->post['category_discount_override_special_price'];
		} else {
			$data['category_discount_override_special_price'] = $this->config->get('category_discount_override_special_price');
		}
		
		if (isset($this->request->post['category_discount_override_discount_price'])) {
			$data['category_discount_override_discount_price'] = $this->request->post['category_discount_override_discount_price'];
		} else {
			$data['category_discount_override_discount_price'] = $this->config->get('category_discount_override_discount_price');
		}
		...
		$discounts = $this->model_catalog_discount->getAllDiscounts('category');
		...
		$this->response->setOutput($this->load->view('catalog/discount_category.tpl', $data));
	}
	...
	public function saveDiscount() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			$this->model_setting_setting->editSetting('category_discount', $settings);
			...
			if(!empty($this->request->post['category_discount'])) {
				...
				$this->model_catalog_discount->setDiscount($discount_data['category_discount'], 'category');		
			} else {
				$this->model_catalog_discount->setDiscount(NULL, 'category');	
			}

...
class ControllerExtensionModuleQuickCheckout extends Equotix {
	...
	public function index() {
		...
		if (isset($this->request->post['quickcheckout_delivery_times_lalamove'])) {
			$data['quickcheckout_delivery_times_lalamove'] = $this->request->post['quickcheckout_delivery_times_lalamove'];
		} elseif (isset($setting['quickcheckout_delivery_times_lalamove'])) {
			$data['quickcheckout_delivery_times_lalamove'] = $setting['quickcheckout_delivery_times_lalamove'];
		} else {
			$data['quickcheckout_delivery_times_lalamove'] = array();
		}
		
		/*if (isset($this->request->post['quickcheckout_delivery_times_cut_off'])) {
			$data['quickcheckout_delivery_times_cut_off'] = $this->request->post['quickcheckout_delivery_times_cut_off'];
		} elseif (isset($setting['quickcheckout_delivery_times_cut_off'])) {
			$data['quickcheckout_delivery_times_cut_off'] = $setting['quickcheckout_delivery_times_cut_off'];
		} else {
			$data['quickcheckout_delivery_times_cut_off'] = array();
		}*/
		...
		if (isset($this->request->post['quickcheckout_delivery_cut_off'])) {
			$data['quickcheckout_delivery_cut_off'] = $this->request->post['quickcheckout_delivery_cut_off'];
		} elseif (isset($setting['quickcheckout_delivery_cut_off'])) {
			$data['quickcheckout_delivery_cut_off'] = $setting['quickcheckout_delivery_cut_off'];
		} else {
			$data['quickcheckout_delivery_cut_off'] = '';
		}

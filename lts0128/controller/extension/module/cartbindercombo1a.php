...
class ControllerExtensionModuleCartbindercombo1a extends Controller {
	...
	private function getList() {
		...
		foreach ($results as $result) {
			...
			$data['cartbindercombo1as'][] = array(
				...
				'multidiscount' 	 	 => $result['multidiscount'],
	...
	private function getForm() {
		...
		if (isset($this->request->post['name'])) {
			...
			$data['name'] = $cartbindercombo1a_info['name'];
		} else {
			$data['name'] = '';
		}
		...
		if (isset($this->request->post['multidiscount'])) {
			...
			$data['multidiscount'] = $cartbindercombo1a_info['multidiscount'];
		} else {
			$data['multidiscount'] = "";
		}
		...
		if (isset($this->request->post['datestart'])) {
			...
			$data['datestart'] = ($cartbindercombo1a_info['datestart'] != '0000-00-00') ? $cartbindercombo1a_info['datestart'] : '';
		} else {
			$data['datestart'] = "";
		}
		...
		if (isset($this->request->post['dateend'])) {
			...
			$data['dateend'] = ($cartbindercombo1a_info['dateend'] != '0000-00-00') ? $cartbindercombo1a_info['dateend'] : '';
		} else {
			$data['dateend'] = "";
		}
		...
		if (isset($this->request->post['autoadd'])) {
			...
			$data['autoadd'] = $cartbindercombo1a_info['autoadd'];
		} else {
			$data['autoadd'] = 0;
		}

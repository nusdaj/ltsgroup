...
class ControllerExtensionModuleCartbindercombo1b extends Controller {
	...
	private function getForm() {
		...
		if (isset($this->request->post['name'])) {
			...
			$data['name'] = $cartbindercombo1b_info['name'];
		} else {
			$data['name'] = '';
		}
		...
		if (isset($this->request->post['datestart'])) {
			...
			$data['datestart'] = ($cartbindercombo1b_info['datestart'] != '0000-00-00') ? $cartbindercombo1b_info['datestart'] : '';
		} else {
			$data['datestart'] = "";
		}
		...
		if (isset($this->request->post['dateend'])) {
			...
			$data['dateend'] = ($cartbindercombo1b_info['dateend'] != '0000-00-00') ? $cartbindercombo1b_info['dateend'] : '';
		} else {
			$data['dateend'] = "";
		}

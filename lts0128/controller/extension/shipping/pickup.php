...
class ControllerExtensionShippingPickup extends Controller {
	...
	public function index() {
		...
		$data['entry_location'] = $this->language->get('entry_status');
		...
		if (isset($this->request->post['pickup_location'])) {
			$data['pickup_location'] = $this->request->post['pickup_location'];
		} else if ($this->config->get('pickup_location')){
			$data['pickup_location'] = $this->config->get('pickup_location');
		} else {

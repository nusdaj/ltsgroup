...
class ControllerExtensionCaptchaGoogleCaptcha extends Controller {
	...
	public function index() {
		...
		// Firstcom Server
		if (isset($this->request->post['google_captcha_firstcomdemolinks_key'])) {
			$data['google_captcha_firstcomdemolinks_key'] = $this->request->post['google_captcha_firstcomdemolinks_key'];
		} else {
			$data['google_captcha_firstcomdemolinks_key'] = $this->config->get('google_captcha_firstcomdemolinks_key');
		}

		if (isset($this->request->post['google_captcha_firstcomdemolinks_secret'])) {
			$data['google_captcha_firstcomdemolinks_secret'] = $this->request->post['google_captcha_firstcomdemolinks_secret'];
		} else {
			$data['google_captcha_firstcomdemolinks_secret'] = $this->config->get('google_captcha_firstcomdemolinks_secret');
		}

		// Xampp / Wamp / Mamp
		if (isset($this->request->post['google_captcha_localhost_secret'])) {
			$data['google_captcha_localhost_secret'] = $this->request->post['google_captcha_localhost_secret'];
		} else {
			$data['google_captcha_localhost_secret'] = $this->config->get('google_captcha_localhost_secret');
		}

		if (isset($this->request->post['google_captcha_localhost_key'])) {
			$data['google_captcha_localhost_key'] = $this->request->post['google_captcha_localhost_key'];
		} else {
			$data['google_captcha_localhost_key'] = $this->config->get('google_captcha_localhost_key');
		}

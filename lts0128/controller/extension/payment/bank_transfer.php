...
class ControllerExtensionPaymentBankTransfer extends Controller {
	...
	public function index() {
		...
		foreach ($languages as $language) {
			...
			if (isset($this->request->post['bank_transfer_extra_note' . $language['language_id']])) {
				$data['bank_transfer_extra_note' . $language['language_id']] = $this->request->post['bank_transfer_extra_note' . $language['language_id']];
			} else {
				$data['bank_transfer_extra_note' . $language['language_id']] = $this->config->get('bank_transfer_extra_note' . $language['language_id']);
			}
		}

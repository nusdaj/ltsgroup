...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_header_announcement'])) {
			$data['header_announcement'] = $this->request->post['config_header_announcement'];
		} else {
			$data['header_announcement'] = $this->config->get('config_header_announcement');
		}
		
		if (isset($this->request->post['config_whatsapplink'])) {
			$data['config_whatsapplink'] = $this->request->post['config_whatsapplink'];
		} else {
			$data['config_whatsapplink'] = $this->config->get('config_whatsapplink');
		}
		
		if (isset($this->request->post['config_emaillink'])) {
			$data['config_emaillink'] = $this->request->post['config_emaillink'];
		} else {
			$data['config_emaillink'] = $this->config->get('config_emaillink');
		}

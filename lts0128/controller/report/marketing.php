...
class ControllerReportMarketing extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/marketing/export', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function export() {
		...
		$marketings_data = array();

		$marketings_data_column = array('Campaign Name', 'Code', 'Clicks', 'No. of Orders', 'Total');
			
		$marketings_data[0]=   $marketings_data_column;   

		foreach($marketings as $marketing) {
			$marketings_data[]=   $marketing;            
		}     

		$excel_data['Campaign'] = $marketings_data;
		
		$filepath = $this->excel->generate($excel_data, true, 'marketing_campaign_report');

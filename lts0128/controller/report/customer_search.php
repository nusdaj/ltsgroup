...
class ControllerReportCustomerSearch extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/customer_search/export', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function export() {
		...
		$products_column = array('Keyword', 'Found Products', 'Category', 'Customer', 'IP', 'Date Added');
		...
		$excel_data['Searches'] = $products;
		
		$filepath = $this->excel->generate($excel_data, true, 'customer_searches_report');

...
class ControllerReportProductViewed extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/product_viewed/export', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function export() {
		...
		$products_column = array('Product Name', 'Model', 'Viewed', 'Percent');
		...
		$excel_data['Products Viewed'] = $products;
		
		$filepath = $this->excel->generate($excel_data, true, 'products_purchased_report');

                ...
                <tr>
                  ...
                  <td class="text-right">
                    <?php if($information['href']){ ?>
                      <a data-href = "<?php echo $information['href']; ?>" onclick = 'copythis(this);' data-toggle="tooltip" title="Click to copy URL" class="btn btn-success">
                      <i class="fa fa-copy"></i>&nbsp;&nbsp;Url</a>
                    <?php } ?>
                  
                  <a href="<?php echo $information['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>

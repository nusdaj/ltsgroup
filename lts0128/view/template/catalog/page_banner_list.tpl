            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'page_name') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($banner['pb_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $banner['pb_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $banner['pb_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $banner['page_name']; ?></td>

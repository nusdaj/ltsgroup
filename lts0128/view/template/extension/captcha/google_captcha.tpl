    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-google-captcha" class="form-horizontal">
          ...
          <fieldset>
            <legend>Firstcom Staging Server / FirstcomDemolinks</legend>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_key; ?></label>
              <div class="col-sm-10">
                <input type="text" readonly name="google_captcha_firstcomdemolinks_key" value="<?php echo $google_captcha_firstcomdemolinks_key; ?>" class="form-control" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_secret; ?></label>
              <div class="col-sm-10">
                <input type="text" readonly name="google_captcha_firstcomdemolinks_secret" value="<?php echo $google_captcha_firstcomdemolinks_secret; ?>" class="form-control" />
              </div>
            </div>
          </fieldset>

          <fieldset>
            <legend>Development Environment (Xampp / Wamp / Mamp)</legend>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_key; ?></label>
              <div class="col-sm-10">
                <input type="text" readonly name="google_captcha_localhost_key" value="<?php echo $google_captcha_localhost_key; ?>" class="form-control" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_secret; ?></label>
              <div class="col-sm-10">
                <input type="text" readonly name="google_captcha_localhost_secret" value="<?php echo $google_captcha_localhost_secret; ?>" class="form-control" />
              </div>
            </div>
          </fieldset>

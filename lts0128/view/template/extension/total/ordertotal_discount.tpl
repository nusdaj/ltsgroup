      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-total" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="ordertotal_discount_status" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="ordertotal_discount_sort_order" value="<?php echo $ordertotal_discount_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
        </form>
      </div>

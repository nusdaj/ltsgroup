...
<script type="text/javascript"><!--
  ...
  function loadLinks() {
    $.ajax({
      url: '<?php echo html($link_get_items); ?>',
      type: 'get',
      dataType: 'json',
  ...
  $('#button-load').bind('click', function(e) {
    ...
    $.ajax({
      url: '<?php echo html($link_get_unlinked_items); ?>',
      type: 'get',
      dataType: 'json',
      beforeSend: function () {
  ...
  function addLink(button, product_id, amazon_sku, variation) {
    $.ajax({
      url: '<?php echo html($link_add_item); ?>',
      type: 'get',
      dataType: 'json',
      async: 'false',
  ...
  function removeLink(button, amazon_sku) {
    $.ajax({
      url: '<?php echo html($link_remove_item); ?>',
      type: 'get',
      dataType: 'json',
  ...
  function openstockCheck(product_id) {
    $.ajax({
      url: '<?php echo html($link_get_variants); ?>',
      dataType: 'json',
      type: 'get',

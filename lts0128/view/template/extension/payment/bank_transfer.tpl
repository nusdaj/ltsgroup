      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bank-transfer" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                <textarea name="bank_transfer_extra_note<?php echo $language['language_id']; ?>" cols="80" rows="10" placeholder="<?php echo $entry_extra_note; ?>" id="input-extra-note<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset(${'bank_transfer_extra_note' . $language['language_id']}) ? ${'bank_transfer_extra_note' . $language['language_id']} : ''; ?></textarea>
              </div>
            </div>
          </div>
          <?php } ?>

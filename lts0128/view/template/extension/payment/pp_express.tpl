...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <?php } ?>
    <div class="alert alert-info stick"> <a data-paypal-button="true" target="PPFrame" href="<?php echo $signup; ?>" ><i class="fa fa-info-circle"></i> <?php echo $text_signup; ?></a>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <div class="alert alert-info stick"> <a data-paypal-button="true" target="PPFrame" href="<?php echo $sandbox; ?>" ><i class="fa fa-info-circle"></i> <?php echo $text_sandbox; ?></a>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>

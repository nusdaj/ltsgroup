          ...
          <table id="module" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <!-- <td class="text-left">Tab Name</span></td> -->
            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][code]" class="form-control">
                  ...
                  <!--
                <td class="text-right"><input type="text" name="layout_module[<?php echo $module_row; ?>][tab_name]" value="<?php echo $layout_module['tab_name']; ?>" class="form-control" /></td>
                  -->
                <td class="text-right"><input type="text" name="layout_module[<?php echo $module_row; ?>][url]" value="<?php echo $layout_module['url']; ?>" placeholder="" class="form-control" /></td>
...
function addModule() {
	...
	<?php } ?>
    html += '  </select></td>';
	//html += '  <td class="text-left"><input type="text" name="layout_module[' + module_row + '][tab_name]" value="" placeholder="" class="form-control" /></td>';
	html += '  <td class="text-left"><input type="text" name="layout_module[' + module_row + '][url]" value="" placeholder="" class="form-control" /></td>';

					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-delivery">
							...
							<div class="row">
								...
								<div class="form-group col-sm-6">
									<label class="col-sm-4 control-label" for="input-delivery-cut_off"><span title="<?php echo "Cut off Time (days)"; ?>" data-toggle="tooltip"><?php echo "Cut off Times"; ?></span></label>
									<div class="col-sm-8">
										<input type="text" name="quickcheckout_delivery_cut_off" value="<?php echo $quickcheckout_delivery_cut_off; ?>" class="form-control" />
									</div>
								</div>
							</div>
							<div class="table-responsive">
								<table id="delivery-time" class="table table-bordered table-hover">
									<thead>
										<tr>
											<td class="text-left" colspan="1"><?php echo $entry_delivery_times; ?></td>
											<td class="text-left" colspan="1"><?php echo "Time Format for Lalamove (eg.13:00:00)"; ?></td>
										...
										<?php foreach ($quickcheckout_delivery_times as $delivery_time) { ?>
											<tr id="delivery-time-<?php echo $delivery_time_row; ?>">
												...
												<td class="text-left"><?php foreach ($languages as $language) {
													...
													<div class="input-group">
														<span class="input-group-addon"><img src="<?php echo version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : 'language/' . $language['code'] . '/' . $language['code'] . '.png'; ?>" title="<?php echo $language['name']; ?>" /></span>
														<input type="text" name="quickcheckout_delivery_times_lalamove[<?php echo $delivery_time_row; ?>][<?php echo $language['language_id']; ?>]" value="<?php echo !empty($quickcheckout_delivery_times_lalamove[$delivery_time_row][$language['language_id']]) ? $quickcheckout_delivery_times_lalamove[$delivery_time_row][$language['language_id']] : ''; ?>" class="form-control" />
													</div>
												<?php } ?></td>
												<!--<td class="text-left"><?php foreach ($languages as $language) {
													?>
													<div class="input-group">
														<span class="input-group-addon"><img src="<?php echo version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : 'language/' . $language['code'] . '/' . $language['code'] . '.png'; ?>" title="<?php echo $language['name']; ?>" /></span>
														<input type="text" name="quickcheckout_delivery_times_cut_off[<?php echo $delivery_time_row; ?>][<?php echo $language['language_id']; ?>]" value="<?php echo !empty($quickcheckout_delivery_times_cut_off[$delivery_time_row][$language['language_id']]) ? $quickcheckout_delivery_times_cut_off[$delivery_time_row][$language['language_id']] : ''; ?>" class="form-control" />
													</div>
												<?php } ?></td>-->
...
<script type="text/javascript"><!--
	...
	function addTime() {
		...
		<?php foreach ($languages as $language) { ?>
			html += '<div class="input-group"><span class="input-group-addon"><img src="<?php echo version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : 'language/' . $language['code'] . '/' . $language['code'] . '.png'; ?>" title="<?php echo $language['name']; ?>" /></span>';
			html += '<input type="text" name="quickcheckout_delivery_times_lalamove[' + delivery_time_row + '][<?php echo $language['language_id']; ?>]" value="" class="form-control" />';
			html += '</div>';
		<?php } ?>
		html += '  </td>';
		/*html += '  <td class="left">';
		<?php foreach ($languages as $language) { ?>
			html += '<div class="input-group"><span class="input-group-addon"><img src="<?php echo version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : 'language/' . $language['code'] . '/' . $language['code'] . '.png'; ?>" title="<?php echo $language['name']; ?>" /></span>';
			html += '<input type="text" name="quickcheckout_delivery_times_cut_off[' + delivery_time_row + '][<?php echo $language['language_id']; ?>]" value="" class="form-control" />';
			html += '</div>';
		<?php } ?>
		html += '  </td>';*/

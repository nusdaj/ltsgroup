  ...
  <div class="page-header">
   ...
   <div class="container-fluid">
      <div class="pull-right">
        <?php /*if($licensed_md5 == 'd9a22d7a8178d5b42a8750123cbfe5b1'){ echo 'license'; ?>
        <?php }*/ ?>
    ...
    <div class="panel panel-default">
          ...
          <h3 class="panel-title offerlist"><i class="fa fa-list"></i> <?php echo $headerinfo; ?></h3>
           ...
           <div class="panel-body">
            ...
            <tr>
              ...
              <td class="text-center multidiscount">Multi Discount</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><?php echo $cartbindercombo1a['multidiscount']; ?></td>

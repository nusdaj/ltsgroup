			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-last_view"><?php echo $entry_status; ?></label>
						<div class="col-sm-10">
							<?php select("mmos_last_view_status", "input-last_view", $mmos_last_view_status, $text_enabled, $text_disabled); ?>
						</div>
					</div>

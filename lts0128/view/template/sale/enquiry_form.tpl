        ...
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-cart">
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody id="cart">
                    <?php if ($enquiry_products || $enquiry_vouchers) { ?>
                    <?php $product_row = 0; ?>
                    <?php foreach ($enquiry_products as $order_product) { ?>
                    <tr>
                    ...
                    <?php } ?>
                    <?php $voucher_row = 0; ?>
                    <?php foreach ($enquiry_vouchers as $order_voucher) { ?>
                    <tr>
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <fieldset>
                <legend><?php echo $text_enquiry_detail; ?></legend>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="order_status_id" id="input-order-status" class="form-control">
                      <?php foreach ($enquiry_statuses as $order_status) { ?>
												<?php if ($order_status['order_status_id'] == $enquiry_order_status_id) { ?>
                    ...
                    <input type="hidden" name="enquiry_order_id" value="<?php echo $enquiry_order_id; ?>" />
                  </div>
                </div>
                <div class="form-group">
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?route=api/enquiry_cart/products&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
		crossDomain: true,
		success: function(json) {
			...
			if (json['totals'].length) {
				for (i in json['totals']) {
					...
					html += '<tr>';
					html += '  <td class="text-right" colspan="2">' + total['title'] + ':</td>';
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
                ...
                var request_1 = $.ajax({
                    url: '<?php echo $catalog; ?>index.php?route=api/enquiry_cart/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
                    type: 'post',
...
$('#cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?route=api/enquiry_cart/remove&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-save').on('click', function() {
	if ($('input[name=\'enquiry_order_id\']').val() == 0) {
		var url = '<?php echo $catalog; ?>index.php?route=api/enquiry/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = '<?php echo $catalog; ?>index.php?route=api/enquiry/edit&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&enquiry_order_id=' + $('input[name=\'enquiry_order_id\']').val();
	}
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['enquiry_order_id']) {
				$('input[name=\'enquiry_order_id\']').val(json['enquiry_order_id']);
			}

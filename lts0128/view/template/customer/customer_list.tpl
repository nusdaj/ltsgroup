            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'c.reward') { ?>
                    <a href="<?php echo $sort_reward; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_reward; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_reward; ?>"><?php echo $column_reward; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['reward']; ?></td>

...
//------------------------------------------------------------------------------
$_['help_charge_type']					= 'Select the basis for the charge:<br /><br />&bull; A simple flat charge or per item charge<br /><br />&bull; A charge based on brackets (quantity, total, weight, etc.)<br /><br />&bull; A charge calculated using another shipping method';

$_['help_charge_charges']				= 'For "Simple Charges", enter the flat charge or per item charge (such as 5.00) or a percentage (such as 10%).<hr />For "Bracket Charges", separate brackets by commas or new lines, and enter them in the format:<br /><br /><b>From - To = Cost / Per</b><br /><br />The "Per" value is optional. If you leave out the "From" value, it will default to the previous bracket&#39;s "To" value (or 0 for the first bracket).<br /><br />For example, to charge $6.00 for 1 to 3 items, and $2.00 per item for 4 or more items, you would choose "Quantity" and enter:<br /><div class="text-left" style="margin: 10px">1-3 = 6.00<br />4-9999 = 2.00 / 1</div><hr />For "Other Shipping Method" charges, enter one or more titles of the rate to charge (such as UPS Ground). Separate multiple titles by commas or new lines.<br /><br />The charge will be the first eligible rate that contains one of these titles. If left blank, the first rate returned will be chosen.';
...
$_['help_setting_override']				= 'Select another shipping method&#39;s setting to override when calculating this charge, and enter the value with which to override it. Hover over a setting in the dropdown to view its default value.<br /><br />For example, if certain products are warehoused in another location, you might use this to override the UPS "ship-from" postcode and state for those products.';
?>
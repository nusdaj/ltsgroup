...
$_['callback'] 			 = '- You need to set the datafeed URL on your PayDollar Merchant Admin Panel > Profile > Profile Settings > Payment Options > Return Value Link (Datafeed).<br/>- URL to be set: ' .HTTP_CATALOG . 'index.php?route=payment/paydollar/callback';

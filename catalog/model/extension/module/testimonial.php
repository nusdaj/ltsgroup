...
class ModelExtensionModuleTestimonial extends Model{
    ...
    public function getReviews($start = 0, $limit = 20) {
        ...
        $query = $this->db->query("SELECT r.review_id, r.image, r.customer_id, r.author, r.rating, r.text, r.date_added FROM " . DB_PREFIX . "review r WHERE r.product_id = '0'  AND r.status = '1'  ORDER BY r.date_added DESC LIMIT " . (int)$start . "," . (int)$limit);

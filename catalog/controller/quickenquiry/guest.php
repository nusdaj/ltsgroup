<?php
class ControllerQuickEnquiryGuest extends Controller {
  	public function index() {

    	$data = $this->load->language('checkout/checkout');
		$data = array_merge($data, $this->load->language('quickcheckout/checkout'));

		$data['guest_checkout'] = ($this->config->get('config_checkout_guest') && !$this->config->get('config_customer_price') && !$this->enquiry->hasDownload());
		...
		$data['register'] = $this->load->controller('quickenquiry/register');

		return $this->load->view('quickenquiry/guest', $data);
  	}

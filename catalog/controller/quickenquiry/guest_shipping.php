<?php
class ControllerQuickEnquiryGuestShipping extends Controller {
  	public function index() {
		  
		$data = $this->load->language('checkout/checkout');
		$data = array_merge($data, $this->load->language('quickenquiry/enquiry'));
		...
		$this->response->setOutput($this->load->view('quickenquiry/guest_shipping', $data));
	}

	public function validate() {
		$this->load->language('enquiry/enquiry');
		$this->load->language('quickenquiry/enquiry');

		$json = array();
		
		// Validate if shipping is required. If not the customer should not have reached this page.
		if (!$this->enquiry->hasShipping()) {
			$json['redirect'] = $this->url->link('quickenquiry/enquiry', '', true);
		}

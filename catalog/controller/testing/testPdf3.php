<?php
    ...
    class ControllerTestingTestpdf3 extends Controller{
        public function index(){
			...
			List example:
			<ol>
				<li><img src="image/tcpdf/logo_example.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
				<li><b>bold text</b></li>
			...
			<img src="image/tcpdf/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="image/tcpdf/tcpdf_box.svg" alt="test alt attribute" width="100" height="100" border="0" /><img src="image/tcpdf/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
			</div>';
			...
			<tr><td><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" /></td></tr>
			<tr style="text-align:left;"><td><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
			<tr style="text-align:center;"><td><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
			<tr style="text-align:right;"><td><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
			<tr><td style="text-align:left;"><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
			<tr><td style="text-align:center;"><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
			<tr><td style="text-align:right;"><img src="image/tcpdf/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
			</table>';
			...
			<ul style="font-size:14pt;list-style-type:img|png|4|4|image/tcpdf/logo_example.png">

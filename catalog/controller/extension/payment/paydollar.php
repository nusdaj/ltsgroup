...
class ControllerExtensionPaymentPayDollar extends Controller {
	...
	public function index() {
		...
		$data ['action'] = $this->config->get ( 'paydollar_payserverurl' );
		...
		$data ['lang'] = $this->config->get ( 'paydollar_lang' );
		...
		$payType = $this->config->get ( 'paydollar_payment_type' );
		...
		$data ['secureHashSecret'] = trim ( $this->config->get ( 'paydollar_security' ) );
		...
		if (file_exists ( DIR_TEMPLATE . $this->config->get ( 'config_template' ) . '/template/extension/payment/paydollar.tpl' )) {
			return $this->load->view($this->config->get('config_template') . '/template/extension/payment/paydollar.tpl', $data);
		} else {
			return $this->load->view('extension/payment/paydollar.tpl', $data);
		}		
	}

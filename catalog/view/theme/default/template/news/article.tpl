...
//--></script> 
<div class="article-inner-btn">
	<div class="flex flex-vcenter">
		<div class="pd-r15 share-lbl"><?= $text_share ?></div>
		<div>
			<a href="http://www.facebook.com/sharer.php?u=<?= $artlink; ?>" target="_blank">
			 	<img src="image/catalog/slicing/happening/icon_happening-sm-fb.png" alt="Facebook" class="img-responsive pd-r10">
    		</a>
    		<a href="https://twitter.com/share?url=<?= $artlink; ?>" target="_blank">
		        <img src="image/catalog/slicing/happening/icon_happening-sm-twitter.png" alt="Twitter" />
		    </a>
		</div>
	</div>
	<div class="back-button"><a class="media-detail__btn pointer" href="<?= $back; ?>" >Back</a></div>
</div>
<?php if ($error_session) { ?>
	<div class="alert alert-danger warning"><i class="fa fa-exclamation-circle"></i>&nbsp;<?php echo $error_session; ?></div>
<?php } else { ?>
	<div class="alert alert-danger warning" id="mastercard_pgs_error" style="display:none;"></div>
	<?php if ($warning_test_mode) { ?>
		<div class="alert alert-warning attention"><i class="fa fa-exclamation-circle"></i>&nbsp;<?php echo $warning_test_mode; ?></div>
	<?php } ?>
	<?php if ($cards) : ?>
	<div class="row">
		<div class="col-xs-12">

...
<div class="prod-inner-container">
	<div id="content" class="<?= $class; ?>">
		...
		<!-- Modal, modified following home.tpl-->
				...
				<div class="modal-body">
					...
					<div class="contact-body">
						<div class="form-group required">
							<input type="text" name="name" value="<?= $name; ?>" id="input-name" class="form-control" placeholder="Name" minlength="3" maxlength="32" />
							<?php if ($error_name) { ?>
						...
						<div class="form-group hidden">
							<input type="text" name="subject" id="input-subject" class="form-control" value="Enquiry from Product Details page"/>
						</div>
						<div class="form-group">
							<input type="text" name="featuredProduct" id="input-product" class="form-control" readonly />
						</div>
						<div class="form-group required">
...
<?php /* AJ Apr 21: check if validation failed. failed, show the modal dialog */ ?>
<?php if ($validation_failed == true) {
  echo  "<script>  $(function() { $('#input-product').val('$featuredProduct'); $('#enquiryModal').modal('show');  }); </script>";
} ?>
